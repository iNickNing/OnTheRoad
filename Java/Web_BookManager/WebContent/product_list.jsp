							...
							<td>
								...
								<div class="pagination">
									<ul>
										...
										<li class="disablepage"><a href="${pageContext.request.contextPath  }/PageServlet?currentPage=${pb.currentPage==1?1:pb.currentPage-1}">&lt;&lt;上一页</a></li>
										
										
										<li>第${pb.currentPage }页/共${pb.totalPage }页</li>

										<li class="nextPage"><a href="${pageContext.request.contextPath  }/PageServlet?currentPage=${pb.currentPage==pb.totalPage?pb.totalPage:pb.currentPage+1}">下一页&gt;&gt;</a></li>
