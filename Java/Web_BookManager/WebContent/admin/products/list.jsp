...
<script type="text/javascript">
	...
	function checkAll() {
		...
		//拿到id_checkAll元素,并得到它的选择状态
		var flag = document.getElementById("id_checkAll").checked;
		//拿到所有ids的复选框元素
		var ids = document.getElementsByName("ids");
		//给每个复选框赋值
		for(var i = 0; i < ids.length; i++) {
			ids[i].checked = flag;	//把所有的ids的状态改成和checkAll的状态
		}
	}
	...
	function delAllBooks() {
		...
		var form2 = document.forms[1]; //同上
		form2.action = "xxx/xxx"
		form2.commit();
		 */
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" witdh="23px"> 
									<input type="checkbox" id="id_checkAll" onclick="checkAll()"/>全选/全不选
								</td>
